...
<body>
    <h3 align= "center">
        <div align="left">
            <a href="customer_index.php?msg=none" class=nav_button>Home</a>
        </div>
...
<?php
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        $a = $row["m_id"];
                        echo "<tr><td>".$row["m_id"]."</td><td>".$row["movie_name"]."</td><td>".$row["movie_desc"]."</td><td>".$row["movie_lang"]."<td>".$row["movie_price"]."</td><td><button class='btn-buy'><a href='checkout.php?a=$a'>Buy Now</a></button></td></tr>";
                    }
                    echo "</table>";
                }else{
                    echo "No Data";
